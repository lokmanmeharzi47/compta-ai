    ...
    <div className="space-y-8 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="glass-card beveled-edge p-6 rounded-2xl flex flex-col justify-between bg-white/70">
          <div>
            <span className="text-xs uppercase font-bold text-outline tracking-widest">{t("totalExpenses")}</span>
        ...
        <div className="glass-card beveled-edge p-6 rounded-2xl flex flex-col justify-between bg-white/70">
          <div>
            <span className="text-xs uppercase font-bold text-outline tracking-widest">{t("budgetUtil")}</span>
        ...
        <div className="glass-card beveled-edge p-6 rounded-2xl flex flex-col justify-between bg-white/70">
          <div>
            <span className="text-xs uppercase font-bold text-outline tracking-widest">{t("topCategory")}</span>
            <h3 className="text-xl font-bold text-on-background mt-1">{t("cloudServices")}</h3>
          </div>
        ...
        <div className="glass-card beveled-edge p-6 rounded-2xl border-error/20 flex flex-col justify-between bg-white/70">
          <div>
            <span className="text-xs uppercase font-bold text-error tracking-widest">{t("flaggedAnomalies")}</span>
          ...
          <p className="text-xs text-error mt-4 font-bold flex items-center gap-1">
            <AlertCircle className="w-4 h-4" /> {t("immediateAttention")}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 glass-card beveled-edge p-8 rounded-3xl relative overflow-hidden flex flex-col justify-between border-primary/10 bg-white/70">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-bold text-lg text-primary">{t("costSavingInsight")}</h4>
            </div>
        ...
        <div className="lg:col-span-2 glass-card beveled-edge p-8 rounded-3xl bg-white/70">
          <div className="flex justify-between items-start mb-8">
            <div>
              <h4 className="font-bold text-lg text-on-background">{t("spendingByCategory")}</h4>
              <p className="text-xs text-on-surface-variant">{t("last30Days")}</p>
            </div>
            ...
            <div className="flex-grow grid grid-cols-2 gap-y-4 gap-x-8">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-on-surface-variant">{t("cloudServices")}</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-on-surface-variant">{t("salaries")}</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-on-surface-variant">{t("rentOffice")}</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-on-surface-variant">{t("marketing")}</span>
      ...
      <div className="glass-card beveled-edge rounded-3xl overflow-hidden bg-white/40">
        <div className="px-8 py-6 border-b border-outline-variant/30 bg-white/40 flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center">
          <h4 className="font-bold text-lg text-on-background">{t("expenseList")}</h4>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto items-center">
            ...
            <div className="flex gap-2">
              ...
              <button className="p-2 ms-2 rounded-lg hover:bg-surface-container transition-colors text-on-surface-variant cursor-pointer" title="Download Export">
          ...
          <table className="w-full text-start">
            <thead>
              <tr className="bg-[#eff4ff]/60 border-b border-outline-variant/20">
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">{t("vendor")}</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">{t("category")}</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">{t("paymentMethod")}</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">{t("date")}</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">{t("amount")}</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider text-center">{t("receipt")}</th>
                <th className="px-8 py-4 text-end">{t("actions")}</th>
              </tr>
            </thead>
          ...
          <div className="relative w-full max-w-lg glass-card beveled-edge p-8 rounded-3xl bg-white shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              <h3 className="font-headline-lg text-2xl font-bold text-on-surface">
                {editingId ? t("editRecord") : t("addNewExpense")}
              </h3>
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                <label className="block text-sm font-bold text-on-surface-variant mb-1">{t("vendorName")}</label>
                <input 
                  type="text" 
                  required
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-bold text-on-surface-variant mb-1">{t("category")}</label>
                  <select 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold text-on-surface-variant mb-1">{t("paymentMethod")}</label>
                  <select 
                    className="w-full px-4 py-3 rounded-xl border border-outline-variant/50 bg-surface-container focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none cursor-pointer"
                ...
                <div>
                  <label className="block text-sm font-bold text-on-surface-variant mb-1">{t("receiptStatus")}</label>
                  <select 
                    className="w-full px-4 py-3 rounded-xl border border-outline-variant/50 bg-surface-container focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none cursor-pointer"
                    value={formData.receipt}
                    onChange={e => setFormData({...formData, receipt: e.target.value})}
                  >
                    <option value="task">{t("uploaded")}</option>
                    <option value="error">{t("missing")}</option>
                  </select>
                </div>
              </div>
