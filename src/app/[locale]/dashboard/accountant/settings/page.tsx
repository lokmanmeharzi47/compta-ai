    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="w-full lg:w-3/4 space-y-8">
              ...
              <div className="md:col-span-2 flex items-center gap-6 pb-6 border-b border-outline-variant/20">
                <div className="relative group">
                  <div className="w-24 h-24 rounded-2xl bg-surface-container-high flex flex-col items-center justify-center overflow-hidden border-2 border-dashed border-outline-variant hover:border-primary transition-all cursor-pointer">
                    ...
                    <span className="text-[10px] font-bold text-primary tracking-wider uppercase mt-1">{t("upload")}</span>
                  </div>
                </div>
                <div>
                  <h4 className="font-bold text-sm text-on-surface">{t("companyLogo")}</h4>
                  <p className="text-on-surface-variant text-xs mt-0.5">{t("logoDesc")}</p>
                </div>
              </div>
          ...
          {/* Section: AI Features */}
          <div className="glass-card beveled-edge rounded-2xl p-8 bg-white/70 border-s-4 border-l-primary">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-sm text-on-surface">{t("aiFeature")}</h3>
          ...
          <div className="glass-card beveled-edge rounded-2xl p-8 bg-white/70">
            ...
            <div className="mt-8 space-y-4">
              <h4 className="text-xs uppercase font-bold text-on-surface-variant tracking-wider">{t("activeMembers")}</h4>
