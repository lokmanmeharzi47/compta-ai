    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70">
          ...
          <p className="text-sm text-on-surface-variant font-medium">{t("totalOutstanding")}</p>
        ...
        <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70">
          ...
          <p className="text-sm text-on-surface-variant font-medium">{t("overdue")}</p>
        ...
        <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70">
          ...
          <p className="text-sm text-on-surface-variant font-medium">{t("paidThisMonth")}</p>
      ...
      <div className="flex flex-col xl:flex-row gap-8 items-start">
        ...
        <div className="flex-1 w-full glass-card beveled-edge rounded-3xl overflow-hidden bg-white/40">
          <div className="p-6 border-b border-outline-variant/30 flex justify-between items-center bg-white/40">
            <h4 className="font-bold text-lg text-on-surface">{t("recentInvoices")}</h4>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-start">
              <thead className="bg-[#eff4ff]/60 border-b border-outline-variant/20">
                <tr>
                  <th className="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">{t("invoiceNum")}</th>
                  <th className="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">{t("client")}</th>
                  <th className="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">{t("issueDate")}</th>
                  <th className="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">{t("amount")}</th>
                  <th className="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider">{t("status")}</th>
                  <th className="px-6 py-4 text-xs font-bold text-on-surface-variant uppercase tracking-wider text-end">{t("actions")}</th>
                </tr>
              </thead>
                  ...
                  return (
                    <tr
                      ...
                      className={`transition-colors cursor-pointer group ${
                        isSelected
                          ? "bg-primary/5 border-s-4 border-primary"
                          : "hover:bg-primary/5"
                      }`}
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        >
                          {invoice.status === "Paid" ? t("statusPaid") : invoice.status === "Sent" ? t("statusSent") : invoice.status === "Overdue" ? t("statusOverdue") : t("statusDraft")}
                        </span>
                      </td>
        ...
        <div className="w-full xl:w-[400px]">
          <div className="glass-card beveled-edge rounded-3xl sticky top-24 overflow-hidden border border-primary/10 shadow-2xl bg-white">
            <div className="p-6 border-b border-outline-variant/30 bg-[#eff4ff]/60 flex justify-between items-center">
              <span className="font-bold text-on-surface text-sm">{t("preview")}</span>
            ...
            <div className="p-8 bg-white min-h-[500px] flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-8 mb-10">
                  <div>
                    <p className="font-bold text-[9px] text-on-surface-variant tracking-wider uppercase mb-2">{t("billTo")}</p>
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-on-surface-variant">
                      {t("number")}: <span className="text-on-surface font-bold">{selectedInvoice.id}</span>
                    </p>
                    <p className="text-[10px] text-on-surface-variant">
                      {t("issued")}: <span className="text-on-surface font-bold">{selectedInvoice.date}</span>
                    </p>
                    <p className="text-[10px] text-on-surface-variant">
                      {t("terms")}: <span className="text-on-surface font-bold">Net 30</span>
                    </p>
                  </div>
                </div>
                  ...
                  <table className="w-full text-[10px]">
                    <thead>
                      <tr className="text-on-surface-variant font-bold border-b border-outline-variant/20">
                        ...
                        <th className="text-end py-2">{t("price")}</th>
                    ...
                    <tbody className="divide-y divide-outline-variant/10 text-on-surface-variant">
                      <tr>
                        ...
                        <td className="text-end py-3">1</td>
                        <td className="text-end py-3">{selectedInvoice.amount}</td>
                        <td className="text-end py-3">{selectedInvoice.amount}</td>
                      </tr>
                    </tbody>
                  </table>
