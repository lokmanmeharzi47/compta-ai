...
export default function RegisterPage() {
  ...
  return (
    <div className="bg-background text-on-background min-h-screen flex flex-col lg:flex-row overflow-x-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full h-full bg-gradient-to-b from-transparent via-transparent to-on-background/80">
          ...
          <div className="max-w-xl">
            ...
            <p className="font-body-md text-base text-white/70 max-w-md">
              Experience the synergy of artificial intelligence and professional accounting in one seamless workspace.
            </p>
          </div>
      ...
      <main className="w-full lg:w-1/2 min-h-screen flex items-center justify-center p-6 sm:p-12 bg-[#eff4ff]">
        <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-[0_40px_60px_-15px_rgba(0,84,214,0.1)] w-full max-w-md p-8 sm:p-12 rounded-3xl">
          <div className="mb-8">
            <h2 className="font-headline-lg text-2xl font-bold text-on-surface mb-2">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block font-label-caps text-xs text-outline mb-2 font-bold tracking-wider">FULL NAME</label>
              <input
            ...
            <div>
              <label className="block font-label-caps text-xs text-outline mb-2 font-bold tracking-wider">BUSINESS EMAIL</label>
              <input
                className="w-full bg-[#f8f9ff]/40 border border-outline-variant/40 rounded-xl px-4 py-3 font-body-md text-sm focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none text-on-surface"
            ...
            <div>
              <label className="block font-label-caps text-xs text-outline mb-2 font-bold tracking-wider">COMPANY NAME</label>
              <input
                className="w-full bg-[#f8f9ff]/40 border border-outline-variant/40 rounded-xl px-4 py-3 font-body-md text-sm focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none text-on-surface"
            ...
            <div>
              <label className="block font-label-caps text-xs text-outline mb-2 font-bold tracking-wider">PASSWORD</label>
              <div className="relative">
                <input
                  ...
                  required
                />
                <button className="absolute right-4 top-1/2 -translate-y-1/2 text-outline hover:text-primary cursor-pointer flex items-center justify-center" type="button">
          ...
          <div className="mt-8 pt-6 border-t border-outline-variant/30 flex justify-between items-center">
            <p className="font-label-caps text-[10px] text-outline font-bold">© 2024 COMPTA AI</p>
