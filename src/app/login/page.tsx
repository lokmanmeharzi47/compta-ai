      ...
      <section className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-secondary relative overflow-hidden items-center justify-center p-16">
        ...
        <div className="relative z-10 max-w-xl text-white">
          ...
          <p className="font-body-md text-white/80 mb-12 max-w-md">
            Experience the precision of high-end fintech tools powered by intelligent AI. Manage your finances with absolute clarity and fluid automation.
          </p>
        ...
        <div className="w-full max-w-[480px]">
          ...
          <div className="bg-white border border-outline-variant/30 p-8 sm:p-10 rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,84,214,0.05)]">
            <header className="mb-8">
              <h3 className="font-headline-lg text-2xl font-bold mb-2 text-on-background">Welcome Back</h3>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <Mail className="absolute right-6 top-1/2 -translate-y-1/2 text-outline w-5 h-5" strokeWidth={1.5} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <Lock className="absolute right-6 top-1/2 -translate-y-1/2 text-outline w-5 h-5" strokeWidth={1.5} />
                </div>
              </div>
