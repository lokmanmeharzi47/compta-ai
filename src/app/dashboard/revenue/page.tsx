  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h2 className="font-headline-lg text-3xl font-bold text-on-surface">Revenue & Earnings</h2>
          <p className="text-body-md text-on-surface-variant">Track declaration payments, commissions, and withdrawals.</p>
        </div>
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-tertiary text-on-tertiary">
              ...
              <p className="text-sm font-medium text-tertiary-container mb-1">Available Balance</p>
              <h3 className="font-headline-lg text-4xl font-bold">28,000 DZD</h3>
              <button className="mt-4 w-full py-2 bg-white/20 hover:bg-white/30 rounded-xl font-bold transition-colors cursor-pointer">
                Withdraw Funds
              </button>
            </div>
            ...
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70 border border-outline-variant/30">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-1">Total Lifetime Earnings</p>
            ...
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70 border border-outline-variant/30">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-1">Approved Declarations</p>
            ...
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70 border border-outline-variant/30">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-1">Pending Payments</p>
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-primary text-on-primary">
              ...
              <p className="text-sm font-medium text-primary-container mb-1">Total Platform Revenue (10%)</p>
              <h3 className="font-headline-lg text-4xl font-bold">12,400 DZD</h3>
            </div>
            ...
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70 border border-outline-variant/30">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-1">Total Transaction Volume</p>
            ...
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70 border border-outline-variant/30">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-1">Total Completed TXs</p>
            ...
            <div className="glass-card beveled-edge p-6 rounded-3xl bg-white/70 border border-outline-variant/30">
              ...
              <p className="text-sm font-medium text-on-surface-variant mb-1">Active Accountants Earning</p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-[#eff4ff]/60 border-b border-outline-variant/20">
              <tr>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">Transaction ID</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">Date & Ref</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider text-right">Gross Total</th>
                {activeTab === "accountant" && (
                  <th className="px-8 py-4 text-xs font-bold text-tertiary uppercase tracking-wider text-right">Your Share (90%)</th>
                )}
                {activeTab === "platform" && (
                  <th className="px-8 py-4 text-xs font-bold text-primary uppercase tracking-wider text-right">Commission (10%)</th>
                )}
            ...
            <tbody className="divide-y divide-outline-variant/10 text-sm">
              {recentTransactions.map((trx) => (
                <tr key={trx.id} className="hover:bg-primary/5 transition-colors">
                  ...
                  {activeTab === "accountant" && (
                    <td className="px-8 py-5 font-mono-data text-right font-bold text-tertiary">
                      +{trx.accShare.toLocaleString()} DZD
                    </td>
                  )}
                  {activeTab === "platform" && (
                    <td className="px-8 py-5 font-mono-data text-right font-bold text-primary">
