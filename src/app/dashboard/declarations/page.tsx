  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
        <div>
          <h2 className="font-headline-lg text-3xl font-bold text-on-surface">Declaration Workflow</h2>
          <p className="text-body-md text-on-surface-variant">Secure collaborative pipeline between Traders and Accountants.</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="glass-card beveled-edge p-5 rounded-2xl bg-white/70 border-t-4 border-outline">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-bold text-sm text-on-surface-variant">Drafts</span>
          </div>
        ...
        <div className="glass-card beveled-edge p-5 rounded-2xl bg-white/70 border-t-4 border-secondary">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-bold text-sm text-on-surface-variant">Sent</span>
          </div>
          <p className="text-3xl font-bold text-on-surface">1</p>
        </div>
        <div className="glass-card beveled-edge p-5 rounded-2xl bg-white/70 border-t-4 border-primary">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-bold text-sm text-on-surface-variant">Reviewing</span>
          </div>
          <p className="text-3xl font-bold text-on-surface">1</p>
        </div>
        <div className="glass-card beveled-edge p-5 rounded-2xl bg-white/70 border-t-4 border-error">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-bold text-sm text-on-surface-variant">Rejected</span>
          </div>
        ...
        <div className="glass-card beveled-edge p-5 rounded-2xl bg-white/70 border-t-4 border-tertiary">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-bold text-sm text-on-surface-variant">Approved</span>
          </div>
        ...
        <div className="px-8 py-6 border-b border-outline-variant/30 bg-white/40 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            <div className="relative w-full sm:w-64">
              ...
              <input 
                type="text" 
                placeholder="Search trader or period..." 
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="bg-[#eff4ff]/60 border-b border-outline-variant/20">
              <tr>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">ID & Period</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">Trader & Accountant</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">Declaration Status</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider">Payment Status</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider text-right">Fee Split</th>
                <th className="px-8 py-4 text-xs font-bold text-outline uppercase tracking-wider text-right">Action</th>
              </tr>
            </thead>
                  ...
                  <tr key={dec.id} className="hover:bg-primary/5 transition-colors group">
                    ...
                    <td className="px-8 py-5 text-right">
                      {dec.status === 'Approved' ? (
                        ...
                        <p className="text-xs text-outline font-bold italic">Awaiting Approval</p>
                      )}
                    </td>
                    <td className="px-8 py-5">
                          ...
                          <div className="flex gap-2">
                            {dec.status === 'Approved' && dec.paymentStatus === 'Pending Payment' && (
                              <button className="flex items-center gap-1 px-3 py-1.5 bg-surface-container text-on-surface rounded-lg text-xs font-bold hover:bg-outline-variant/20 transition-colors cursor-pointer border border-outline-variant/30">
                                <Wallet className="w-3 h-3" /> Pay Fee
                              </button>
                            )}
                            <button className="flex items-center gap-1 px-3 py-1.5 bg-surface-container text-on-surface rounded-lg text-xs font-bold hover:bg-outline-variant/20 transition-colors cursor-pointer border border-outline-variant/30">
